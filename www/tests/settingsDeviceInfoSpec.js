...
describe('SettingsDeviceView', function() {
  ...
  it('should display the device name as provided by the model', function() {
     expect(this.view.$el.find('#info-device-name').val()).toMatch(this.model.get('deviceName'));
  });

  it('should display the brand as provided by model', function() {
     expect(this.view.$el.find('#info-brand').val()).toMatch(this.model.get('brand'));
  });

  it('should display the model as provided by the model', function() {
     expect(this.view.$el.find('#info-model').val()).toMatch(this.model.get('model'));
  });

  it('should display the serial as provided by the model', function() {
     expect(this.view.$el.find('#info-serial').val()).toMatch(this.model.get('serial'));
  });

  it('should display the operating system as provided by the model', function() {
     expect(this.view.$el.find('#info-operating-system').val()).toMatch(this.model.get('operatingSystem'));
  });

  it('should display the interfaces as provided by the model', function() {
     expect(this.view.$el.find('#info-interfaces').val()).toMatch(this.model.get('interfaces').join(','));
  });

  it('should display the uptime as provided by the model', function() {
     expect(this.view.$el.find('#info-uptime').val()).toMatch(this.model.get('uptime').join(','));
  });
