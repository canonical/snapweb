...
class GulpPlugin(PluginV1):
    ...
    def schema(cls):
        ...
        schema['properties']['gulp-version'] = {
            'type': 'string',
            'default': '3',
        }
    ...
    def get_build_properties(cls):
        ...
        return ["gulp-tasks", "gulp-version"]
    ...
    def build(self):
        ...
        self.run(['npm', 'install', '-g', 'gulp@{}'.format(self.options.gulp_version)], env=env)
